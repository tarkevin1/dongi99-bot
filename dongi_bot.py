...
print("--- STARTING FINAL BOT VERSION (ALL HANDLERS VERIFIED) ---")
...
if not DATABASE_URL:
    # فال‌بک به دیتابیس محلی برای تست، در صورتی که ربات روی سرور نباشد
    print("WARNING: DATABASE_URL not found. Falling back to local sqlite file.")
...
def main() -> None:
    ...
    if not TELEGRAM_BOT_TOKEN:
        print("خطا: توکن تلگرام یافت نشد. لطفا متغیر محیطی TELEGRAM_TOKEN را تنظیم کنید.")
        return
